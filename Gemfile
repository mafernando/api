...
group :test, :development, :staging do
  ...
  # gem 'jellyfish-aws', path: '../jellyfish-aws'
  gem 'jellyfish-demo', github: 'mafernando/jellyfish-demo', branch: 'demo/odl-aws'
  gem 'jellyfish-odl', github: 'mafernando/jellyfish-odl', branch: 'demo/odl-aws'
  gem 'jellyfish-aws', github: 'mafernando/jellyfish-aws', branch: 'demo/odl-aws'
end
